...
const medicines = [
  { id: 1, name: 'بنادول أكسترا', category: 'مسكنات', price: 15, image: '', description: 'مسكن للألم وخافض للحرارة', prescription: false },
  { id: 2, name: 'أموكسيسيلين 500mg', category: 'مضادات حيوية', price: 35, image: '', description: 'مضاد حيوي واسع المجال', prescription: true },
  { id: 3, name: 'أوميبرازول 20mg', category: 'معدة', price: 25, image: '', description: 'لعلاج حموضة المعدة', prescription: false },
  { id: 4, name: 'ميتفورمين 850mg', category: 'سكري', price: 20, image: '', description: 'لعلاج السكري النوع الثاني', prescription: true },
  { id: 5, name: 'فيتامين د 5000', category: 'فيتامينات', price: 30, image: '', description: 'مكمل فيتامين د', prescription: false },
  { id: 6, name: 'لوسارتان 50mg', category: 'ضغط', price: 28, image: '', description: 'لعلاج ارتفاع ضغط الدم', prescription: true },
  { id: 7, name: 'سيتريزين 10mg', category: 'حساسية', price: 12, image: '', description: 'مضاد للحساسية', prescription: false },
  { id: 8, name: 'أتورفاستاتين 20mg', category: 'كوليسترول', price: 40, image: '', description: 'لخفض الكوليسترول', prescription: true }
];
