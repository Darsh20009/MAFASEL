...
const DEPARTMENT_KEYWORDS = {
  medical: ['مرض', 'ألم', 'علاج', 'دواء', 'أعراض', 'تشخيص', 'فحص', 'تحليل', 'أخصائي', 'طبيب', 'عملية', 'جراحة', 'وصفة', 'حالة صحية', 'مركز', 'مستشفى', 'عيادة', 'صحة', 'مرضي', 'يؤلم', 'وجع', 'التهاب'],
...
معلومات المستفيد المسجلة في ملفه:
...
اكتب تقريراً طبياً مهنياً بناءً على المحادثة التالية مع المستفيد.

التقرير يجب أن يكون:
- مكتوب كتقرير طبي حقيقي من أخصائي حقيقي
...
- اكتب بصيغة الأخصائي: "بعد مراجعة الحالة..."، "بناءً على الأعراض المذكورة..."
- وقّع التقرير باسمك ولقبك

${userProfile ? `معلومات المستفيد: ${userProfile.name}` : ''}

أعراض ورسائل المستفيد:
${userMessages.join('\n---\n')}

ملاحظات الأخصائي خلال المحادثة:
