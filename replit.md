...
- صفحة عرض تقديمي احترافية على `/presentation`
- 12 شريحة: الغلاف، الهوية البصرية، الرؤية والرسالة، المشكلة والحل، نظرة شاملة + mockup، الاستشارات، الذكاء الاصطناعي + mockup محادثة، الأدوار والمستخدمين، البنية التقنية، الأمان والحماية، لوحة الإدارة، خارطة الطريق
- تصميم داكن احترافي مع تأثيرات glow وانتقالات سلسة
- شريط تنقل جانبي بنقاط (dots navigation)
- تنقل بالكيبورد (أسهم + مسافة) وتمرير snap
- Mockup هاتف تفاعلي لعرض واجهة التطبيق
